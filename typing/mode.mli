...
(**************************************************************************)
(* Modes *)
include module type of Modes
  with type 'a var = 'a Modes.var
  and type 'a mode = 'a Modes.mode
  and type ('loc, 'u, 'lin) modes = ('loc, 'u, 'lin) Modes.modes

module Locality : sig
  include module type of Modes.Locality with
  type const = Modes.Locality.const
...
module Uniqueness : sig
  include module type of Modes.Uniqueness with
  type const = Modes.Uniqueness.const
...
module Linearity : sig
  include module type of Modes.Linearity with
  type const = Modes.Linearity.const
...
module Alloc : sig
  include module type of Modes.Alloc with
  type const = Modes.Alloc.const
  ...
  val check_const : t -> (Locality.const option, Uniqueness.const option, Linearity.const option) Modes.modes
...
module Regionality : sig
  include module type of Modes.Regionality
...
module Value : sig
  include module type of Modes.Value
  ...
  val check_const : t -> (Regionality.const option, Uniqueness.const option, Linearity.const option) Modes.modes
