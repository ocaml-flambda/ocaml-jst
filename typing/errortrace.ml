...
type ('a, 'variety) elt =
  ...
  | Bad_layout : type_expr * Type_layout.Violation.t -> ('a, _) elt
  | Bad_layout_sort : type_expr * Type_layout.Violation.t -> ('a, _) elt
  | Unequal_univar_layouts :
      type_expr * Type_layout.t * type_expr * Type_layout.t -> ('a, _) elt
