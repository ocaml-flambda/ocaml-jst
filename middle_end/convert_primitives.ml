...
let convert (prim : Lambda.primitive) : Clambda_primitives.primitive =
  ...
  | Pstring_load_16 is_unsafe ->
      Pstring_load (Sixteen, convert_unsafety is_unsafe, Lambda.alloc_heap_shared)
  ...
  | Pbytes_load_16 is_unsafe ->
      Pbytes_load (Sixteen, convert_unsafety is_unsafe, Lambda.alloc_heap_shared)
  ...
  | Pbigstring_load_16 is_unsafe ->
      Pbigstring_load (Sixteen, convert_unsafety is_unsafe, Lambda.alloc_heap_shared)
