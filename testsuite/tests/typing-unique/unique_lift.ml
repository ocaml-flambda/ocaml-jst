...
let update_with_constant (p : point) =
  ...
  q
[%%expect{|
Line 2, characters 10-63:
2 |   let q = { unique_ p with dim = 2; x = 2.0; y = 3.0; z = 4.0 } in
              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Warning 23 [useless-record-with]: all the fields are explicitly listed in this record:
the 'with' clause is useless.
val update_with_constant : point -> point = <fun>
|}]
...
let fupdate_with_constant (p : fpoint) =
  ...
  q
[%%expect{|
Line 2, characters 10-54:
2 |   let q = { unique_ p with x = 2.0; y = 3.0; z = 4.0 } in
              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Warning 23 [useless-record-with]: all the fields are explicitly listed in this record:
the 'with' clause is useless.
val fupdate_with_constant : fpoint -> fpoint = <fun>
|}]
